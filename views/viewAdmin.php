...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Dashboard Admin
        <small>Registrasi dan Tabel Admin</small>
      </h1>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#modal-default">Reg Admin</button>
            </div>
            <div class="box-header">
                                ...
                                <form class="form-horizontal" action="../proses/prosesAdmin.php?aksi=edit" method="post">
                                 <div class="box-body">
                                  <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="inputIDAdmin" name="inputIDAdmin" value="<?php echo $key['ID_ADMIN']; ?>" enable="false">
                                  </div>
                                  <div class="form-group">
            ...
            <form class="form-horizontal"  action="../proses/prosesAdmin.php?aksi=tambah" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" id="inputUsername" name="inputUsername">
                  </div>
                </div>
                <div class="form-group">
